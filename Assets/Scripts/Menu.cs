    ...
    void Update()
    {
        if (topIsSelected)
        {
            ...
            if (!launched)
            {
                ...
                Top.GetComponent<Rigidbody>().velocity = Vector3.up * 7 + Vector3.left * 5 + Vector3.back * 5;
        ...
        if (bottomIsSelected)
        {
            if (!launched)
            {
                ...
                Bottom.GetComponent<Rigidbody>().velocity = Vector3.up * 7 + Vector3.left * 5 + Vector3.back * 5;
